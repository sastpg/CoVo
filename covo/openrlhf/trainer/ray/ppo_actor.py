...
from openrlhf.datasets import PromptDataset, SFTDataset, EvalDataset
...
class ActorModelRayActor(BasePPORole):
    ...
    def prepare_datasets(self):
        ...
        self.eval_dataloader = strategy.setup_dataloader(
            eval_dataset, len(eval_dataset) // (strategy.world_size // strategy.ring_attn_size), True, False, drop_last=False
        )
