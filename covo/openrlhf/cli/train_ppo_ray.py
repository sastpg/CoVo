...
if __name__ == "__main__":
    ...
    # Custom parameters
    parser.add_argument("--logging_path", type=str, default=None, help="Save output path")
    parser.add_argument("--save_output_path", type=str, default=None, help="Save output path")
    parser.add_argument("--enable_curiosity", action="store_true", default=False, help="whether to use curiosity reward")
    parser.add_argument("--enable_accuracy_filter", action="store_true", default=False, help="whether to use online filter")
    parser.add_argument(
        "--intrinsic_reward",
        type=str,
        choices=["riv", "ril"],
        default="riv",
        help="Choose accuracy estimation method: riv, ril",
    )
